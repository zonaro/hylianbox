...
| **Equipped-item touch icons**             | Shipped     | —                                            | The standard touch overlay reads the supported OoT/MM SaveContext at runtime and replaces C-Left/C-Down/C-Right, B sword and R shield labels with exact icons extracted locally from the user's ROM. The mapped-area/minimal overlay remains unchanged. |
