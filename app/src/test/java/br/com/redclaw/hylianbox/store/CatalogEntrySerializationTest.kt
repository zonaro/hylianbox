...
class CatalogEntrySerializationTest {
    ...
    fun hackEntryDownloadTargetRoundTrips() {
        val original = HackEntry(
            ...
            author = "a",
            version = "1.0",
            baseRom = br.com.redclaw.hylianbox.data.model.BaseRomRef(
                "OoT", "CZLE", -1,
                br.com.redclaw.hylianbox.data.model.Checksums("", null, null)
            ),
            storeId = "picks",
            ...
            changelog = listOf(
                br.com.redclaw.hylianbox.data.model.ChangelogEntry("2024", "done")
            ),
    ...
    fun hackEntryDirectPatchTargetRoundTrips() {
        val patch = br.com.redclaw.hylianbox.data.model.PatchRef(
            "https://x/y.bps", "y.bps", 10,
            br.com.redclaw.hylianbox.data.model.Checksums("abc", null, null)
        )
        val original = HackEntry(
    ...
    fun hackEntryLegacyNoTargetStillParses() {
        ...
        val original = HackEntry(
            ...
            patch = br.com.redclaw.hylianbox.data.model.PatchRef(
                "https://x/y.bps", "y.bps", 10,
                br.com.redclaw.hylianbox.data.model.Checksums("abc", null, null)
            )
        )
