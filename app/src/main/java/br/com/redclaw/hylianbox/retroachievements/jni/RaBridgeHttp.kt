 ...
 *
 * Both the gameplay session ([br.com.redclaw.hylianbox.retroachievements.session.RaSessionManager])
 * and interactive login ([br.com.redclaw.hylianbox.retroachievements.auth.RaAuthService])
...
fun executeServerRequest(
    ...
    url: String,
    postData: String?,
    outbox: br.com.redclaw.hylianbox.retroachievements.sync.RaAwardOutbox? = null
) {
