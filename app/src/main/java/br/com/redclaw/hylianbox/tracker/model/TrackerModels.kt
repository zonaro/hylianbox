...
package br.com.redclaw.hylianbox.tracker.model

import androidx.annotation.DrawableRes
import androidx.annotation.StringRes

/**
 * Which game the tracker is tracking. Mirrors [br.com.redclaw.hylianbox.ocarina.OcarinaGame].
 */
...
data class TrackerItem(
        ...
        /**
         * Cache key for ROM-extracted PNG (defaults to [id]). When a cached PNG exists it is used
         * instead of [iconRes].
         */
