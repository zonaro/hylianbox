...
import br.com.redclaw.hylianbox.data.local.BaseRomRepository
import br.com.redclaw.hylianbox.data.local.InstalledHacksRepository
import br.com.redclaw.hylianbox.data.local.UserHacksRepository
import br.com.redclaw.hylianbox.data.model.BaseRom
import br.com.redclaw.hylianbox.data.model.BaseRomRef
...
import br.com.redclaw.hylianbox.patcher.PatcherException
...
import br.com.redclaw.hylianbox.views.LocalPatchesSource
import java.io.File
 ...
 *
 * Mirrors the proven logic in [br.com.redclaw.hylianbox.store.DownloadManager]: for BPS it
...
class ImportedPatchInstaller(
        ...
        private fun gameNameRes(game: br.com.redclaw.hylianbox.ocarina.OcarinaGame?): Int =
                when (game) {
                        br.com.redclaw.hylianbox.ocarina.OcarinaGame.OOT -> R.string.game_oot
                        br.com.redclaw.hylianbox.ocarina.OcarinaGame.MM -> R.string.game_mm
