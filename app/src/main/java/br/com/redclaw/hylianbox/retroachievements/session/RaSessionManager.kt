package br.com.redclaw.hylianbox.retroachievements.session
...
import br.com.redclaw.hylianbox.retroachievements.data.RaInstallMetadataStore
import br.com.redclaw.hylianbox.retroachievements.jni.RaNativeListener
import br.com.redclaw.hylianbox.retroachievements.jni.RcheevosJni
import br.com.redclaw.hylianbox.retroachievements.jni.executeServerRequest
...
class RaSessionManager(
    ...
    override fun onServerRequest(requestId: Int, url: String, postData: String?) {
        executeServerRequest(scope, http, requestId, url, postData,
            br.com.redclaw.hylianbox.HylianBoxApp.raAwardOutbox)
    }
