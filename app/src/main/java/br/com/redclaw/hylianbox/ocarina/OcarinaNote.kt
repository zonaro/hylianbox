 ...
 *
 * The touch pad ([br.com.redclaw.hylianbox.gamepad.GamePadConfig]) maps each
 * N64 face button to a raw keycode before it reaches
 * [br.com.redclaw.hylianbox.input.InputMapper]:
 ...
 * [br.com.redclaw.hylianbox.input.ControllerInput] so no side effects
