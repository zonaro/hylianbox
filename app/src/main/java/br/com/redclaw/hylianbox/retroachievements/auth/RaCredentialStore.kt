...
class RaCredentialStore(private val context: Context) {
     ...
     *
     * This is the key from https://retroachievements.org/controlpanel.php used
     * as the `y` query parameter of the Web API. It is distinct from the
     * rcheevos login token ([getToken]) and is required by the profile screen.
     * Treat as secret: never log or display.
     */
