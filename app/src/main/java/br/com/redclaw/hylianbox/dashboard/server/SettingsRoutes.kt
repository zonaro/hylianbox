...
package br.com.redclaw.hylianbox.dashboard.server
 ...
 *
 * Allows the web dashboard to read and update server settings such as port, password, and display
 * preferences.
 */
 ...
 */
private fun appSettings(context: Context): List<DashboardPreference> =
        listOf(
...
private fun bool(key: String, value: Boolean) =
        DashboardPreference(key, "boolean", value.toString())

private fun choice(key: String, value: String, options: List<String>) =
...
@Serializable
internal data class DashboardPreference(
        val key: String,
        val type: String,
        val value: String,
